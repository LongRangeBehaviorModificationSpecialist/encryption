...
class KeyFileEncryptor:
    ...
    def generate_new_key_file(self, key_file_path: Path) -> str:
        ...
        with open(key_file_name, 'wb') as f:
            Functions.write_to_file(self, file=f, message=key)
...
[{Functions.get_date_time(self)}] Key File Name: {os.path.basename(key_file_name)}""")
    ...
    def get_key_data_to_encrypt_file(self,
        ...
        # key_file = 'K:\\encryption\\aaa\\2024-01-24_105425_key.key'
...
`{os.path.basename(key_file)}` loaded successfully""")
        ...
        # file_path = 'K:\\encryption\\aaa\\File_2_Folder_2_for_KEY.txt'
    ...
    def encrypt_file_with_new_key(self, file_path: Path) -> None:
...
=============================================""")
        ...
        key_file_name = KeyFileEncryptor.generate_new_key_file(self,
                                                               key_file_path)
...
=====================================================""")
            ...
            # folder_path_for_key_test = Functions.get_folder_path(
            #     self,
            #     text='containing the files to be encrypted')
            # folder_path_for_key_test = 'K:\\encryption\\aaa\\txtfiles02'
            ...
            if delete_choice.lower().strip() == 'y':
                ...
                Functions.print_original_files_deleted(self,
                                                   folder_path=folder_path_for_key_test,
                                                   action='ENCRYPTED')
                return False
